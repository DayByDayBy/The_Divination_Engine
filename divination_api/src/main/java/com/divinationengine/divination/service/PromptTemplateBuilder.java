...
public class PromptTemplateBuilder {
    ...
    public String buildThreeCardPrompt(List<CardInterpretDTO> cards, String userContext) {
        if (cards == null) {
        ...
        return String.format("""
            ...
            4. Avoids making absolute predictions about the future
            5. Maintains a supportive, empowering tone
            
            Remember: This is for reflection and insight, not fortune-telling.
            """, cardsDescription, userContext != null ? userContext : "No specific context provided");
    }
    
    public String buildCelticCrossPrompt(List<CardInterpretDTO> cards, String userContext) {
        if (cards == null) {
        ...
        return String.format("""
            ...
            Remember: This is for reflection and insight, not fortune-telling.
            """, cardsDescription.toString(), userContext != null ? userContext : "No specific context provided");
    }
}
